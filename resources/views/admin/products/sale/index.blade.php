    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">Product Sale</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h5 class="card-title">Product Sale</h5>
                            <a href="{{ route('create-sale') }}" class="btn btn-primary btn-sm" title="plus">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center"> 
                                            <a href="{{ route('show-sale', $product->id) }}" class="btn btn-success btn-sm" title="View"><i class="bi bi-eye"></i></a>
                                            <a href="{{ route('edit-sale', $product->id) }}" class="btn btn-warning btn-sm mx-2" title="Edit"><i class="bi bi-pencil"></i></a>
